        ...
        describe("Commands", function() {
            describe("*Single Record*", function() {
                ...
                describe("remove", function() {
                    beforeEach(function() {
                        this.ref1 = subject.ref();
                        test1 = subject.remove(this.key);
                        $rootScope.$digest();
                        this.mainRef = subject.ref().root().child("geofire").child(this.key);
                        flushTime();
                        $rootScope.$digest();
                    });
                    it("should be a promise", function() {
            ...
            describe("*Multiple Records", function() {
                ...
                describe("add()", function() {
                    ...
                    it("should add coordinates to coordinates node", function() {
                        ...
                        expect(d.getData()[this.keys[1]]).toEqual({
                            "g": jasmine.any(String),
                            "l": [45, 100]
                        });
                    });
                    it("should return an array of firebaseRefs", function() {
                        expect(getPromValue(test)[0].toString()).toEqual(rootPath + "/geofire/" + this.keys[0]);
                    ...
                    it("should set current ref to the last main array record", function() {
                        expect(subject.path()).toEqual(rootPath + "/geofire/" + this.keys[1]);
                    });
                    qReject(0);
                });
                describe("remove", function() {
